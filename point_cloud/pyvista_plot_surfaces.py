...
file_list = glob.glob(os.path.join(folder_path, "Point_Clouds_Full_Version.txt"))
...
for i, file in enumerate(file_list):
    ...
    pcd_clean, _ = pcd.remove_statistical_outlier(nb_neighbors=30, std_ratio=5)
    ...
    plotter.add_mesh(surf, color=color, opacity=0.6, show_edges=False)
